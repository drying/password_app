...
def manage_view(page: ft.Page) -> ft.Container:
    ...
    def open_form_dialog(entry=None):
        ...
        return ft.Container(
            content=ft.Row(
                controls=[
                    ...
                    ft.IconButton(icon=ft.Icons.EDIT, icon_size=18, on_click=lambda e: open_form_dialog(entry), tooltip="編集"),
                ...
                ft.Row(
                    controls=[
                        ft.FloatingActionButton(
                            icon=ft.Icons.ADD,
                            bgcolor="#1e95d4",
                            on_click=lambda _: open_form_dialog(),
                        )
                    ],
